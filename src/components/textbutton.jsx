...
const bgGradients = {
    ...
    inactive:
        'linear-gradient(to top, rgb(121, 121, 121) 0%, rgb(151, 151, 151) 100%)',
}
...
export default class TextButton extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            bg: !this.props.inactive
                ? bgGradients.neutral
                : bgGradients.inactive,
            text: !this.props.inactive
                ? textColours.neutral
        ...
        return (
            <div
                ...
                onMouseEnter={() =>
                    this.state.active &&
                    this.setState({
                        bg: this.state.mouseDown
                            ? bgGradients.neutral
                            : bgGradients.hover,
                        text: this.state.mouseDown
                            ? textColours.clicked
                            : textColours.neutral,
                    })
                }
